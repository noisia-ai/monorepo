...
export function buildClaudeSignalNamingPrompt(
  ...
  return [
    ...
    "Para detectar riesgo creativo, saturacion o gap de pauta, cruza knowledge base/brief/campanas/performance/fuentes estructuradas con la serie mensual, matching_creatives.match_basis/matched_terms, structured_source_events y repeated_marketing_language: que prometio la marca, que pauta/organico/search/reviews/ecomm/ventas empujo o midio, que se repitio, que paso alrededor y que evidencia sostiene o descarta la conexion.",
