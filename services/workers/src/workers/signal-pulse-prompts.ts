...
export function buildClaudeSignalNamingPrompt(
  ...
  return [
    ...
    "No trabajes desde la keyword provisional. Esa palabra sólo identifica el cluster. La tesis debe salir del cruce entre period_series, weekly_series, conversation_matches semanticos, knowledge_matches, samples con id, performance_context, marketing_activity_window y repeated_marketing_language.",
