...
function ImportForm({canCancelUpload,onCancelUpload,onRefreshStatus,simple=false,busy,connectors,error,locale,onRegisterQuery,onSubmit,queries,readyForImport,result,t,timezone}:{
