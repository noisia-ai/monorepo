...
import { canAdministerSignalTaxonomyV1 } from "@/lib/data-os/signal-topics-narratives-admin";
import {
  loadSignalTaxonomyTagV1,
  reviewSignalTaxonomyTagV1
...
export async function GET(
  ...
  const tag = await loadSignalTaxonomyTagV1({
