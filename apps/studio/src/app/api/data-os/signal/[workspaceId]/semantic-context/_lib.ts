...
function operatorMessage(code:string){return({
  ...
  ,topic_evaluation_v2_snapshot_unavailable:"The frozen full-evidence snapshot is not available."
  ,topic_evaluation_v2_cluster_not_found:"The requested frozen cluster is not available."
  ,topic_evaluation_v2_context_authority_invalid:"The requested Brand OS context is not current."
  ,topic_evaluation_v2_cursor_invalid:"The evidence page changed. Return to the first page."
  ,topic_evaluation_v2_forbidden:"Full-evidence Topic Evaluation requires an internal operator."
  ,topic_evaluation_v2_disabled:"The full-evidence evaluator is installed but provider execution is disabled."
