...
function operatorMessage(code:string){return({
  ...
  ,topic_catalog_forbidden:"This user cannot manage Topics in the selected workspace."
  ,topic_catalog_busy:"A Topics search or publication is already running."
  ,topic_catalog_empty:"Create or adopt a topic before starting a search."
  ,topic_candidate_not_found:"The discovery candidate is no longer available."
  ,topic_not_found:"The topic is no longer available."
  ,topic_revision_conflict:"The topic definition changed. Refresh before saving again."
  ,topic_population_not_available:"The workspace does not have an operational population ready for Topics."
  ,topic_population_watermark_missing:"The operational population is not ready for a reproducible Topics search."
  ,topic_search_result_not_ready:"Complete a valid Topics search before publishing to Signal."
  ,topic_catalog_requires_edit_before_search:"The current served catalog remains stable until a new definition is prepared."
  ,topic_queue_unavailable:"The Topics job was not accepted by the processing queue. Retry is safe."
  ,topic_result_not_found:"The selected mention result is no longer available."
  ,topic_evaluation_duplicate_envelope:"This sealed evaluation input already has a flight. A generic start cannot create another."
  ,topic_evaluation_successor_confirmation_required:"Confirm the explicit one-call successor flight before continuing."
  ,topic_evaluation_successor_predecessor_ineligible:"Only an ambiguous-after-send terminal flight can receive an explicit successor."
  ,topic_evaluation_successor_flight_card_drift:"The successor flight card changed. Refresh and obtain new authority."
  ,topic_evaluation_successor_already_exists:"This ambiguous flight already has a successor authority."
