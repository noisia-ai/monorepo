    ...
    pool.query(
      `
        ...
        SELECT
          ...
          cs.signal_type,
          cs.dimensions,
          COALESCE(cs.dimensions->>'period_read', '') AS period_read,
          COALESCE(cs.dimensions->>'window_read', '') AS window_read,
          COALESCE(cs.dimensions->>'marketing_hypothesis', '') AS marketing_hypothesis,
          COALESCE(cs.dimensions->>'next_month_decision', '') AS next_month_decision,
          COALESCE(cs.dimensions->>'marketing_read', '') AS marketing_read,
          COALESCE(cs.dimensions->>'action_hint', '') AS action_hint,
          COALESCE(cs.dimensions->>'performance_connection', '') AS performance_connection,
