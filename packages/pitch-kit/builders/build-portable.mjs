...
// Stamp the output as generated. In one case, copy edits were made on the portable file instead
// of index.html and survived only because someone diffed them back; any rebuild would have wiped
// them without warning. The marker makes the file say what it is to whoever opens it.
const stamp = `<!--\n  GENERATED by builders/build-portable.mjs from ${input}.\n  Do NOT edit this file: edits are lost on the next build. Edit index.html and rebuild.\n-->\n`;
html = html.replace(/^(<!doctype html>\s*)/i, `$1${stamp}`);
