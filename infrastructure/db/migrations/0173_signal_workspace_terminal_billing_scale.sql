-- Match the existing numeric(10,4) ledger column when validating an exact
-- micro-USD terminal settlement. The unrounded predicate rejected legitimate
-- audited costs that were not whole ten-thousandths of a dollar.
