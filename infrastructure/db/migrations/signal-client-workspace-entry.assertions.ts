...
/** Identical composed assertions for local and private synthetic fixtures. */
export async function assertClientWorkspaceEntryV1(t:Pick<TestContext,'test'>,
 f:Awaited<ReturnType<typeof workspaceProjectionFixtureV1>>){
  try{
