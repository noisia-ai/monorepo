...
async function verifySchema(client: pg.Client) {
  const requiredTables = [
    ...
    "signal_semantic_context_proposal_revalidations"
  ];
  const requiredIndexes = [
    ...
    "idx_signal_mention_semantic_eligible",
    "idx_signal_mention_attribution_review_events_assertion",
    "idx_signal_population_policy_bundles_workspace",
    "idx_signal_population_policy_entities_bundle",
    "uq_signal_population_policy_compilation_current",
    "idx_signal_population_policy_compilations_population",
    "uq_signal_governed_view_binding_current",
    "idx_signal_governed_view_binding_events_history",
    "idx_signal_quality_policies_workspace",
    "idx_signal_retention_policies_workspace",
    "idx_signal_licensing_policies_workspace",
    "idx_signal_licensing_policy_usages_workspace",
    "idx_signal_provenance_policy_bindings_source",
    "idx_signal_data_governance_policy_events_object",
    "idx_signal_governed_view_population_derivations_base",
    "idx_signal_data_governance_evaluations_population",
    "idx_signal_data_governance_evaluation_items_reason",
    "idx_signal_data_governance_invalidations_compilation",
    "idx_signal_classification_items_coverage",
    "idx_signal_classification_assignments_current",
    ...
    "idx_signal_semantic_context_revalidation_history"
  ];
